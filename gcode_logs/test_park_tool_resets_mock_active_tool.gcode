...
G90                          ; Absolute Mode.
G53 G0 X274.0 Y259.0 F12000    ; Rapid to the back of the post. Stay away from the tool rack so we don't collide with tools.
G53 G1 Y329.0 F6000            ; Controlled move to the park position with tool-1. (park_x, park_y)
