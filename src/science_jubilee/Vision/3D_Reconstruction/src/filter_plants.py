...
def filter_gaussians(input_ply, output_ply, 
    ...
    valid_mask = is_inside_bbox & mask_opacity & mask_scale & is_elongated & (~is_white_cloud) & (~is_orange_artifact)
    ...
    if len(filtered_data) > 0:
        ...
        cl, valid_indices = pcd.remove_statistical_outlier(nb_neighbors=nb_neighbors, std_ratio=std_ratio)
...
if __name__ == "__main__":
    ...
    # Boîte englobante
    parser.add_argument("--bbox_size", type=float, default=0.5, help="Taille du cube en mètres (0.5 = 50cm)")
    ...
    filter_gaussians(args.input, args.output, args.opacity_threshold, 
                     args.scale_threshold, args.white_sat_thresh, 
                     args.white_val_thresh, args.ban_hue_min, args.ban_hue_max,
                     args.elongation_threshold, args.bbox_size, center, 
